...
class BaseController:
    def __init__(self, arduino, base_frame, name="base_controllers"):
        ...
        self.odomPub = rospy.Publisher('odom_enc', Odometry, queue_size=5)
    ...
    def poll(self):
	    ...
	    ir = 0
	    for ir in range (0,36):
	       if(ir == 0 or ir == 7 or ir == 14):
	           odom.pose.covariance[ir] = .01
	     
	       elif (ir == 21 or ir == 28 or ir== 35):
	           odom.pose.covariance[ir] += 0.1
	     
	       else:
	           odom.pose.covariance[ir] = 0;
